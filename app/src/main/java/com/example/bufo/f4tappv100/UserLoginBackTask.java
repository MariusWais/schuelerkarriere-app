...
public class UserLoginBackTask extends AsyncTask<String,Void,String> { // Hintergrungd Task für die Afrage von Daten
    ...
    protected String doInBackground(String... params) { // Hintergund Operationen
        ...
        String login_url = "https://www.schuelerkarriere.de/app/user_login.php";
        ...
        String method = params[0];
         if(method.equals("login")){ // Wenn Login vorliegt
            ...
            try {
                ...
                String data = URLEncoder.encode("login_mail","UTF-8")+"="+URLEncoder.encode(login_mail,"UTF-8")+"&"+URLEncoder.encode("login_pass","UTF-8")+"="+URLEncoder.encode(login_pass,"UTF-8");
    ...
    protected void onPostExecute(String result) {   // Nach Ausführung starten
        ...
        if (result != null && result.equals("Login success")) {  //Wenn Registrierung erfolgreich ist gibt es eine Meldung

            Intent myIntent = new Intent(ctx, AddVita.class);
