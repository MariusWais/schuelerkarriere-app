...
public class EditVitaBackTask extends AsyncTask<String,Void,String> {//Hintergrungd Task für die Afrage von Daten
    //Deklarierung
    AlertDialog alertDialog;
    Context ctx;

    EditVitaBackTask(Context ctx) {
        this.ctx = ctx;
    } // Kontext
    ...
    protected String doInBackground(String... params) { // Hintergrundaktivität
        ...
        String vita_url = "https://www.schuelerkarriere.de/app/edit_vita.php";
